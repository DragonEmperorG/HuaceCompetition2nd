...
def get_conv_block(input_time_steps, kernel_size=(3, 3), nb_filter=32, repetations=4):
    ...
    for i in range(repetations):
        ...
        time_dis_layer_list.append(time_dis_bn_layer)
...
def tec_pre_net(tec_map_shape, input_time_steps=36, output_time_steps=24, external_dim=5):
    ...
    dim_reduce = Convolution2D(1, (3,3), padding="same", name="dim_reduce_conv_3*3", activation="relu")
    ...
    for i in range(output_time_steps - 1):
        ...
        new_x_0 = TimeDistributed(bn33_layer, input_shape=(1, Params.map_rows, Params.map_cols, nb_filter))(new_x_0)
        ...
        new_x_1 = TimeDistributed(bn55_layer, input_shape=(1, Params.map_rows, Params.map_cols, nb_filter))(new_x_1)
        ...
        new_x_2 = TimeDistributed(bn77_layer, input_shape=(1, Params.map_rows, Params.map_cols, nb_filter))(new_x_2)
